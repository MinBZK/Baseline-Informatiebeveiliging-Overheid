const organisationConfig = {
  ...
  sotdText: {
    nl: {
      ...
      wv: `Dit is een werkversie waarin wijzigingen zijn opgenomen die goedgekeurd zijn door de Werkgroep BIO. De definitieve publicatie van de volgende juridisch geldende versie van de BIO is gepland in het najaar van 2027.`,
